...
public class Beverage {
    ...
    @ColumnInfo(name="beverageDescription")
    ...
    public String getBeverageDescription(){return this.beverageDescription;}
    ...
    public void setBeverageDescription(String desp){this.beverageDescription = desp;}
    public Beverage(String id, String type, String img, String name, Integer quantity, double rating, String cost, boolean bestseller, String description){
        this.beverageId = id;
        ...
        this.beverageDescription = description;
    }
    public Beverage(){}
